...
class BrowsingErrorPagesTest {
    ...
    private val malwareMessage = getStringResource(R.string.mozac_browser_errorpages_safe_browsing_malware_uri_message)
    ...
    fun blockMalwarePageTest() {
        ...
        }.submitQuery(malwareURl) {
            verifyPageContent("Malware site issue")
            // verifyPageContent(malwareMessage)
        }
    }
